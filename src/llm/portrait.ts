...
function buildUserPrompt(opts: GeneratePortraitOptions): string {
  ...
  lines.push('Сгенерируй портрет в фирменном тоне (см. system instruction). Длина 1000-1800 знаков. Каждый астрологический термин объясни в скобках при первом упоминании.');
